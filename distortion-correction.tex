...
\Echapter{Distortion Correction with Conditionals}{Daniel J. Peterson}{djpeters@uw.edu}
...
To help understand the behavior of \maken{}, below is an example of a ``toy'' makefile, which does not call any real programs, and can operate on empty ``dummy'' files. When debugging and developing makefiles it can be useful to write such simplified makefiles, and run them with \maken{}\texttt{-n}.
