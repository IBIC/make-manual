...
\addbibresource{neuro.bib}

% Complex packages
\usepackage{tcolorbox} 	% frames
\usepackage{listings} 	% allows for adding $ at the beginning of lines
\usepackage{xcolor} % extends Latex color facilities
%\usepackage{minted}		% pretty source code
\usepackage{fancyvrb}
...
\newcommand*{\lnote}{\stepcounter{codehighlight}\llap{{\lnum{\thecodehighlight}}\hskip 1em}}
...
\begin{document}
	...
	\begin{vplace}[0.7]
		\begin{center}
			\includegraphics[width=0.7\linewidth, natwidth=1890, natheight=761]{IBIClogo.png}				% IBIC logo
...
%%	\include{documentation} % How to document makefiles
	\include{makefile-examples} % Makefile examples
