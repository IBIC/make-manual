...
\begin{document}
	...
	\include{manual/chapter1}	% Introduction to make
	
	\include{manual/chapter2}	% Running make in context
	
	\include{manual/chapter3}	% Running make in parallel
	
	\include{manual/chapter4}  % Examples
	...
	\include{practica/practicum1}	% Overview of make
	
	\include{practica/practicum2} 	% Make in context
	
	\include{practica/practicum3} 	% Getting down and dirty
	
	\include{practica/practicum4}	% Advanced topics & R markdown
	...
	\include{examples/makefile-examples} % How to execute FreeSurfer using make
